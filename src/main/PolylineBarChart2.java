...
//		DefaultCategoryDataset dataset1 = new DefaultCategoryDataset(); // bar chart 1
		...
		DefaultCategoryDataset dataset1 = new DefaultCategoryDataset(); // bar chart 2
...
//		 그래프 2
//
//		dataset1.addValue(8, "S2", "Ch1");
//
//		dataset1.addValue(9, "S2", "Ch2");
//
//		dataset1.addValue(4, "S2", "Ch3");
//
//		dataset1.addValue(5, "S2", "Ch4");
//
//		dataset1.addValue(2, "S2", "Ch5");
//
//		dataset1.addValue(6, "S2", "Ch6");
//
//		dataset1.addValue(9, "S2", "Ch7");
//
//		dataset1.addValue(5, "S2", "Ch8");
//
//		dataset1.addValue(6.0, "S2", "Ch9");
//
//		dataset1.addValue(7, "S2", "Ch10");
//
//		dataset1.addValue(7, "S2", "etc");
//
//		dataset1.addValue(7, "S2", "etc");

		// 그래프 3

		dataset2.addValue(17.0, "1회차", "Ch1");

		dataset2.addValue(15.0, "1회차", "Ch2");

		dataset2.addValue(12.0, "1회차", "Ch3");

		dataset2.addValue(18.0, "1회차", "Ch4");

		dataset2.addValue(11.0, "1회차", "Ch5");

		dataset2.addValue(16.0, "1회차", "Ch6");

		dataset2.addValue(15.0, "1회차", "Ch7");

		dataset2.addValue(14.0, "1회차", "Ch8");

		dataset2.addValue(13.0, "1회차", "Ch9");

		dataset2.addValue(18.0, "1회차", "Ch10");

		dataset2.addValue(11.0, "1회차", "etc");

		dataset2.addValue(10.0, "1회차", "etc");

		// 그래프 4

		dataset3.addValue(17.0, "2회차", "Ch1");

		dataset3.addValue(11.0, "2회차", "Ch2");

		dataset3.addValue(3.0, "2회차", "Ch3");

		dataset3.addValue(14.0, "2회차", "Ch4");

		dataset3.addValue(15.0, "2회차", "Ch5");

		dataset3.addValue(17.0, "2회차", "Ch6");

		dataset3.addValue(19.0, "2회차", "Ch7");

		dataset3.addValue(16.0, "2회차", "Ch8");

		dataset3.addValue(17.0, "2회차", "Ch9");

		dataset3.addValue(13.0, "2회차", "Ch10");

		dataset3.addValue(11.0, "2회차", "etc");

		dataset3.addValue(12.0, "2회차", "etc");

		// 그래프 5

		dataset4.addValue(15.0, "3회차", "Ch1");

		dataset4.addValue(19.0, "3회차", "Ch2");

		dataset4.addValue(13.0, "3회차", "Ch3");

		dataset4.addValue(12.0, "3회차", "Ch4");

		dataset4.addValue(11.0, "3회차", "Ch5");

		dataset4.addValue(12.0, "3회차", "Ch6");

		dataset4.addValue(11.0, "3회차", "Ch7");

		dataset4.addValue(13.0, "3회차", "Ch8");

		dataset4.addValue(14.0, "3회차", "Ch9");

		dataset4.addValue(15.0, "3회차", "Ch10");

		dataset4.addValue(16.0, "3회차", "etc");

		dataset4.addValue(17.0, "3회차", "etc");

		// 그래프 5

//		dataset5.addValue(6.0, "4회차", "Ch1");
//
//		dataset5.addValue(8.0, "4회차", "Ch2");
//
//		dataset5.addValue(11.0, "4회차", "Ch3");
//
//		dataset5.addValue(15.0, "4회차", "Ch4");
//
//		dataset5.addValue(9.0, "4회차", "Ch5");
//
//		dataset5.addValue(10.0, "4회차", "Ch6");
//
//		dataset5.addValue(7.0, "4회차", "Ch7");
//
//		dataset5.addValue(9.0, "4회차", "Ch8");
//
//		dataset5.addValue(15.0, "4회차", "Ch9");
//
//		dataset5.addValue(15.0, "4회차", "Ch10");
//
//		dataset5.addValue(11.0, "4회차", "etc");
//
//		dataset5.addValue(9.0, "4회차", "etc");
...
//	        renderer.setSeriesPaint(0, new GradientPaint(1.0f, 1.0f, Color.white, 0.0f, 0.0f, Color.blue));
		...
		renderer1.setSeriesPaint(0, new Color(232, 168, 255));
		...
		renderer2.setSeriesPaint(0, new Color(101, 26, 214));
		...
		renderer5.setSeriesPaint(0, new Color(232, 107, 107));
